...
Released on XX, XXth, 2022.
  ...
  - New Features:
    ...
    - Added a way of importing PROTO files from different projects by setting the `WEBOTS_PROTO_PATH` environment variable ([#4364](https://github.com/cyberbotics/webots/pull/4364)).
  - New Objects:
