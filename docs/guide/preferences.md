...
Additionally, but exclusively to import PROTO nodes, the environment variable `WEBOTS_EXTRA_PROTO` can be used. This method allows setting multiple paths by separating them with `:`.
